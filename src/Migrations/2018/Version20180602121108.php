 ...
 */
class Version20180602121108 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE auto_stake ADD CONSTRAINT FK_674CB39EACF41FFE FOREIGN KEY (balance) REFERENCES auto_stake_balance (id) ON DELETE CASCADE');
    }
